...
const PEDIDOS_YA_URL = "https://www.pedidosya.com.ar/restaurantes/rosario/rizoma"; // ← reemplazá con tu URL real
...
const ZONA_COBERTURA = [
  ...
  // ← agregá o quitá barrios según corresponda
];
    ...
    <div className="min-h-screen bg-black text-white px-6 py-10">
      <div className="max-w-sm mx-auto space-y-8">
        ...
        {/* Botón PedidosYa */}
          ...
          className="flex items-center justify-between w-full bg-[#FA0050] hover:bg-[#d4003f] transition p-5 rounded-2xl text-white font-semibold text-lg"
        >
          <div className="flex items-center gap-3">
            <img
              src="https://logodownload.org/wp-content/uploads/2019/07/pedidos-ya-logo.png"
              alt="PedidosYa"
        ...
        <div className="bg-zinc-900 rounded-2xl p-5 space-y-3 border border-zinc-800">
          ...
          <p className="text-xs text-zinc-500">
            ¿No encontrás tu barrio? Consultanos por WhatsApp.
          </p>
        </div>
        ...
        <Link
          href="/"
          className="block w-full text-center bg-zinc-800 hover:bg-zinc-700 transition px-4 py-3 rounded-2xl text-white font-semibold"
        >
          Volver al inicio
        </Link>
